        ...
        <div className="space-y-8">
          {educationList.map((edu, index) => (
            <div
              ...
              className="bg-purple-400 border-8 border-black p-8 md:p-10 shadow-lg hover:shadow-2xl transform transition-all duration-300 hover:-translate-y-3 hover:scale-105 cursor-pointer rounded"
            >
              {/* Degree */}
